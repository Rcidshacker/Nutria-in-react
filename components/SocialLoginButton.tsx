...
interface SocialLoginButtonProps {
  ...
  icon: React.ReactNode; // Expecting an SVG or similar
}
...
export const FacebookIcon: React.FC<{ className?: string }> = ({className = "w-6 h-6"}) => (
  <svg className={className} viewBox="0 0 24 24" fill="#1877F2" xmlns="http://www.w3.org/2000/svg">
    <path d="M22,12C22,6.48,17.52,2,12,2S2,6.48,2,12c0,5.04,3.66,9.21,8.44,9.88V15.47H8.08v-3.47h2.35V9.61c0-2.32,1.36-3.61,3.51-3.61c1,0,1.85,0.07,2.1,0.11v2.94h-1.73c-1.13,0-1.35,0.54-1.35,1.32v1.74h3.27l-0.42,3.47h-2.85v6.41C18.34,21.21,22,17.04,22,12Z" />
  </svg>
);
