  ...
  return (
    <div className={`mb-4 ${containerClassName}`}>
      ...
      <div className="relative">
        ...
        <input
          id={id}
          className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-melon-500 focus:border-melon-500 dark:bg-cocoa-700 dark:text-peach-100 placeholder-cocoa-400 dark:placeholder-cocoa-500 transition-colors duration-200 ease-in-out ${icon ? 'pl-10' : ''} ${className} ${error ? 'border-red-500' : `border-clay-300 dark:border-cocoa-600`}`}
          {...props}
        />
      </div>
