    ...
    <div className="p-4 sm:p-6 max-w-screen-md mx-auto pb-20">
      <div className="text-center mb-8">
        <img
          ...
          alt="User Avatar"
          className="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-melon-500 dark:border-melon-400"
        />
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">{user?.name}</h1>
        <p className="text-melon-600 dark:text-melon-300">{user?.email}</p>
      </div>
      ...
      <div className="space-y-3 mb-8">
        {PROFILE_LINKS.map(link => {
          ...
          return (
            ...
            >
              <IconComponent className="w-6 h-6 mr-4 text-melon-500 dark:text-melon-400" />
