      ...
      <div className="max-w-md mx-auto p-4 sm:p-6 space-y-6">
        ...
        {!imagePreview ? (
          <div className="bg-white dark:bg-cocoa-800 rounded-xl border-2 border-dashed border-clay-300 dark:border-cocoa-600 p-8 text-center">
            ...
            <p className="text-lg font-medium text-cocoa-800 dark:text-peach-100 mt-4 mb-2"> Snap or upload your meal photo </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
              <Button onClick={handleCameraCapture} fullWidth className="flex justify-center items-center"> <Camera className="w-5 h-5 mr-2" /> Camera </Button>
              <Button onClick={handleFileUpload} variant="outline" fullWidth className="flex justify-center items-center"> <Upload className="w-5 h-5 mr-2" /> Upload </Button>
            </div>
          </div>
        ) : (
